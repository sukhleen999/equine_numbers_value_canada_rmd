...
```{r plot horses, fig.width=10, fig.height=3, fig.cap= "Figure 1. Horse populations for all provinces in Canada between 1940 - 1972"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap= "Figure 2. Horse populations for 'r params$province' between 1940 - 1972"}
